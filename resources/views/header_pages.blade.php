		...
		<div class='f-b-primary f-b-b three'>
			<div class='f-app-ribbon'>
				<div class='f-page-container responsive'>
					<div
						class='js-collapse-icon collapse-icon f-p-l-medium f-clickable'>
...
.knockout svg #fund-text path {
	fill: #f2f2f4
					...
					<ul class='middle js-collapse-show f-z-appribbon'>
						<li
							class='f-font-condensed f-bg-hover-xlight f-p-xsmall f-m-r-xsmall f-br-small'>
					...
					<div class='js-links f-fs-small right'>
						...
						<a class='f-button white f-m-r-small f-fw-bold' href="#"
							onclick="show('signin1')">Ulogujte se</a>
...
function hide(target) {
    document.getElementById(target).style.display = 'none';
						...
						@include('users.signin1') <a class='f-button primary f-fw-bold'
							href='{{URL::to('/')}}/kampanje/nova'>Pokrenite kampanju</a>
								...
								<div
									...
									<div
										...
										<ul class='f-list f-fc-black f-b-white'>
											@if (Session::has('brojneprocitanih'))
...
$('#zeleni').text('NOVE PORUKE!({{Session::get("brojneprocitanih")}})');
											...
											<li style='display: block'><a href='{{URL::to('/')}}/users/poruke/{{Auth::user()->id}}'><i
													class='f-fc-medium fa fa-envelope fa-fw f-m-r-xsmall'></i><span>Poruke
														(<span id='brojnepro'>{{Session::get('brojneprocitanih')}}</span>)
												</span>
											</a></li> @endif
											...
											<li style='display: block'><a href='{{URL::to('/')}}/users/{{Auth::user()->id}}'><i
													class='fa fa-fw fa-user f-m-r-xsmall'></i><span>Moj Profil</span>
											</a></li>
