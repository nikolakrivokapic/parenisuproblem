...
<title>{{$project->naslov}} | Pare nisu problem
</title>
<meta charset='utf-8'>
...
<meta content="Klikni na podržiš {{$project->naslov}}" property='og:title'>
<meta content='https://parenisuproblem.com/{{$project->slug}}' property='og:url'>
<meta content='{{str_replace(" ","%20",$project->slika)}}' property='og:image'>
...
<link rel="apple-touch-icon" sizes="57x57" href="{{ URL::to('/') }}/assets/apple-icon-57x57.png">
<link rel="apple-touch-icon" sizes="60x60" href="{{ URL::to('/') }}/assets/apple-icon-60x60.png">
<link rel="apple-touch-icon" sizes="72x72" href="{{ URL::to('/') }}/assets/apple-icon-72x72.png">
<link rel="apple-touch-icon" sizes="76x76" href="{{ URL::to('/') }}/assets/apple-icon-76x76.png">
<link rel="apple-touch-icon" sizes="114x114" href="{{ URL::to('/') }}/assets/apple-icon-114x114.png">
<link rel="apple-touch-icon" sizes="120x120" href="{{ URL::to('/') }}/assets/apple-icon-120x120.png">
<link rel="apple-touch-icon" sizes="144x144" href="{{ URL::to('/') }}/assets/apple-icon-144x144.png">
<link rel="apple-touch-icon" sizes="152x152" href="{{ URL::to('/') }}/assets/apple-icon-152x152.png">
<link rel="apple-touch-icon" sizes="180x180" href="{{ URL::to('/') }}/assets/apple-icon-180x180.png">
<link rel="icon" type="image/png" sizes="192x192"  href="{{ URL::to('/') }}/assets/android-icon-192x192.png">
<link rel="icon" type="image/png" sizes="32x32" href="{{ URL::to('/') }}/assets/favicon-32x32.png">
<link rel="icon" type="image/png" sizes="96x96" href="{{ URL::to('/') }}/assets/favicon-96x96.png">
<link rel="icon" type="image/png" sizes="16x16" href="{{ URL::to('/') }}/assets/favicon-16x16.png">
<link rel="manifest" href="{{ URL::to('/') }}/assets/manifest.json">
<meta name="msapplication-TileColor" content="#ffffff">
<meta name="msapplication-TileImage" content="/ms-icon-144x144.png">
<meta name="theme-color" content="#ffffff">

<link href="//fonts.googleapis.com/css?family=Roboto:100,100italic,300,300italic,400,400italic,500,500italic,700,700italic,900,900italic|Roboto+Condensed:300,300italic,400,400italic,700,700italic" media="screen" rel="stylesheet" type="text/css" />
...
<link href="{{URL::to('/')}}/css/style-53a92.css" media="screen" rel="stylesheet" type="text/css" />
...
<div class='f-bg-xlight f-height-100' style="background-color:{{$project->boja}}" >
...
<a class='f-anchor' data-mp-action='Start Campaign Click' data-mp-position='App Ribbon' href='{{ URL::to('/') }}/kampanje/nova'>Pokrenite kampanju</a>
<a class='f-p-l-large' data-mp-action='Search Click' data-mp-position='App Ribbon' href='{{URL::to('/')}}/pretraga'>Pretraga</a>
</div>
@if(!Auth::check())
<a class='f-button white f-m-r-small f-fw-bold f-fs-small' href='#' onclick="show('signin1')">Uloguj se</a>
@endif
...
<a href='{{URL::to('/')}}/users/poruke/{{Auth::user()->id}}'><i class='f-fc-medium fa fa-envelope fa-fw f-m-r-xsmall'></i><span>Poruke (<span id='brojnepro'>{{$brojneprocitanih}}</span>)</span>
</a>
</li>    @endif
<li style='display:block'>
