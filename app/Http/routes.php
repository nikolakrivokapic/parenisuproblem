...
Route::group([
    ...
    Route::get('/da-li-ovaj-servis-kosta', function () {
        return View::make('faq.dalikosta');
    });
    Route::get('/kako-vam-mozemo-pomoci', function () {
        return View::make('faq.kakomozemopomoci');
    });
    Route::get('/kako-funkcionisemo', function () {
        return View::make('faq.kakofunkcionisemo');
    });
    Route::get('/kako-sakupiti-sredstva', function () {
        return View::make('faq.kakodasakupite');
    });
    Route::get('/kako-voditi-kampanju', function () {
        return View::make('faq.uspjesnovodjenje');
    });
    Route::get('/o-nama', function () {
        return View::make('pages.onama');
    });
